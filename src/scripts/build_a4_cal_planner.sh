...
YEAR_CAL_TEMP=Planner-Yearly-A4
QUAT_PLAN_TEMP=Planner-Quartarly-A4
WEEK_PLAN_TEMP=Planner-Weekly-A4
DAY_PLAN_TEMP=Planner-Daily-A4
PLAN_TEMP_PATTERN=Planner-*.png
RES_DIR=../res
BUILD_DIR=../../build_planner
...
function build_quartarly()
{
    ...
    do
      ...
      convert  \
        ...
        -fill black \
        -pointsize 24 \
        -draw "text 40,50 '$header'" \
        -pointsize 16 \
        -draw "text 210,100 '$m1'" \
        -draw "text 390,100 '$m2'" \
        -draw "text 570,100 '$m3'" \
        $src_file \
        $dest_file
...
function build_weekly()
{
    ...
    while [[ "$start_Mon" != "$end_Mon" ]]; do
      ...
      convert  \
        ...
        -fill black \
        -pointsize 24 \
        -draw "text 50,50 '$header'" \
        -draw "text 380,50 '$kw'" \
        -pointsize 17 \
        -draw "text 50,308 '$date_mon'" \
        -draw "text 50,428 '$date_tue'" \
        -draw "text 50,548 '$date_wed'" \
        -draw "text 50,668 '$date_thu'" \
        -draw "text 50,788 '$date_fri'" \
        -draw "text 50,908 '$date_sat'" \
        -draw "text 50,1028 '$date_sun'" \
        $src_file \
        $dest_file
