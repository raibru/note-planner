...
WEEK_PLAN_TEMP=Planner-Weekly-RB
RES_DIR=../res
BUILD_DIR=../../build
...
function build_weekly()
{
    ...
    do
      ...
      convert  \
        ...
        -draw "text 710,50 '$kw'" \
        -draw "text 420,105 '$date_mon'" \
        -draw "text 420,245 '$date_tue'" \
        -draw "text 420,385 '$date_wed'" \
        -draw "text 420,525 '$date_thu'" \
        -draw "text 420,665 '$date_fri'" \
        -draw "text 420,805 '$date_sat'" \
        -draw "text 420,945 '$date_sun'" \
        -font FreeMono \
        -fill black \
        -pointsize 17  \
